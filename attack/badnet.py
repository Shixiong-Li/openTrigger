...
class BadNet(NormalCase):
    ...
    def stage1_non_training_data_prepare(self):
        ...
        bd_train_dataset = prepro_cls_DatasetBD_v2(
            ...
            attack=args.attack,
            blend_image_files_path=args.attack_trigger_img_path if args.attack == 'OpenTrigger' else None,
            blend_ratio=args.attack_train_blended_alpha if args.attack == 'OpenTrigger' else None
        )
        ...
        bd_test_dataset = prepro_cls_DatasetBD_v2(
            ...
            attack=args.attack,
            blend_image_files_path=args.test_trigger_img_path if args.attack == 'OpenTrigger' else None,
            blend_ratio=args.attack_test_blended_alpha if args.attack == 'OpenTrigger' else None
        )
